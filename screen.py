...
def draw_text(screen: Surface, text: str, x: int, y: int, color: tuple=(255,255,255)) -> None:
    """
...
def draw_wrapped_text(screen: Surface, text: str, x: int, y: int, max_width: int, color: tuple=(255, 255, 255)) -> None:
    """
